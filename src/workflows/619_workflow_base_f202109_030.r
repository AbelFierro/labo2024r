...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$train$training <- c(202107,202106,202105, 202102, 202101,
    202012,201912,201911,201910)
  param_local$train$validation <- c(202103,202001)
  param_local$train$testing <- c(202104,202002)
