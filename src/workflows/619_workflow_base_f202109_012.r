...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$train$training <- c(201907,201910,201911,201912,
                                  202011,202012,202103,202104,202105)
  param_local$train$validation <- c(201908,202010,202106)
  param_local$train$testing <- c(201909,202009,202107)
